...
public class MagicAdventureApp {
  ...
  private void startNewGame() {
    System.out.println("Luffy, the best student of Hogwards, is on his journey to free his dad from the tyranny of the most evil wizard the world has known, named Arlong. Arlong has kidnapped several high-tier wizards, such as Monkey D. Dragon, which is Luffy's dad, using his blue haki spell 'THE WATER!'");
    System.out.println();
